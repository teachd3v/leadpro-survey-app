      ...
      <div style={{ marginBottom: '1rem', padding: '0.5rem 1rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem' }}>
          ...
          <div style={{ textAlign: 'left' }}>
            <h1 style={{ fontSize: '1.8rem', color: '#fff', marginBottom: '0.2rem', lineHeight: 1.2 }}>Leadership Project BAKTI NUSA 15</h1>
            <p style={{ color: 'var(--accent-blue)', fontSize: '0.9rem', fontWeight: 600, margin: 0 }}>Explore the Leadership Project</p>
          </div>
        </div>
